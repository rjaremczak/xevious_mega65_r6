...
; Example: If your HEAP_SIZE would be 29696, then you write
;  29696-MENU_HEAP_SIZE=28672 instead, 
; but when doing the sanity check calculations, you use 29696
...
; the ROM file
HEAP_SIZE       .EQU 5120                       ; 7168 - MENU_HEAP_SIZE
HEAP            .BLOCK 1
...
HEAP_SIZE       .EQU 27648                      ; 29696 - MENU_HEAP_SIZE
HEAP            .BLOCK 1
